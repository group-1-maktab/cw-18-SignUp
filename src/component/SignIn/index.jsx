  ...
  return (
    <div className="w-screen h-screen bg-[#0f1f37] flex align-center justify-center items-center ">
      <form className="w-1/4 h-2/3 bg-[#576272] p-4 mt-4 flex flex-col rounded-md gap-2">
        ...
        <span className="text-white font-md cursor-pointer">Don’t have an account?</span>
        <span className="text-[#bcc02f] font-bold m-1 cursor-pointer" onClick={() => handleBtn(true) }>Sign Up</span>
        </div>
      </form>
    </div>
  );
